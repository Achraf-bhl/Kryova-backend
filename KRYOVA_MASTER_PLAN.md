...
| E12 | Load cases, materials, standard parts | **in progress — materials now have tests (2026-09-06)**; `app/parts/` and `load_library.py` still `TESTS NOT WRITTEN` | `app/solve/materials.py`, `tests/test_materials.py`, `app/parts/` |
