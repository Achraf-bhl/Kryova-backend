...
| E7 | V&V: NAFEMS, convergence, provenance | **in progress — convergence now has tests (2026-09-06)**; the rest of the package (benchmarks, provenance, the validation register) still `TESTS NOT WRITTEN` | `app/verify/`, `tests/test_verify_convergence.py` |
