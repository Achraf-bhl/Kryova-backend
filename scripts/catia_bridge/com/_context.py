...
class ComContext(Protocol):
    ...
    def _discard_failed_feature(self, shape: Any) -> None: ...
    def _solid_volume(self) -> float: ...
    # Declared here since 2026-09-19: `TolerancingMixin` needs it too, and the seam rule is
    # that a helper with two users moves here rather than being reached for across mixins.
    def _face_reference(self, face: str, *, feature: str = "") -> Any: ...
