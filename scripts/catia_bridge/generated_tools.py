        ...
        WRITE,
        {
            ...
            "properties": {
                "file": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The uploaded file to import, by name.",
                },
                "format": {
                    "type": "string",
                    "enum": [
        ...
        READ,
        {
            ...
            "properties": {
                "body": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Restrict to one body or geometrical set.",
                },
                "kind": {
                    "type": "string",
                    "maxLength": 60,
        ...
        READ,
        {
            ...
            "properties": {
                "body": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Measure one body rather than the whole part.",
                },
                "include_inertia": {
                    "type": "boolean",
        ...
        WRITE,
        {
            ...
            "properties": {
                "feature": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Update only this feature and its parents.",
                }
            },
            "required": [],
            "additionalProperties": False,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "origin": {
                    ...
                    "description": "Where the sketch's own (0, 0) sits on the support. Defaults to the support's own origin.",
                },
            },
            "required": ["support"],
            "additionalProperties": False,
        ...
        WRITE,
        {
            ...
            "properties": {
                "sketch": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The sketch to close. Defaults to the open one.",
                }
            },
            "required": [],
            "additionalProperties": False,
        ...
        READ,
        {
            ...
            "properties": {
                "sketch": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The sketch to analyse.",
                }
            },
            "required": [],
            "additionalProperties": False,
        ...
        WRITE,
        {
            ...
            "properties": {
                "at": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Where to put the point.",
                },
                "sketch": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The sketch to draw in.",
                },
                "construction": {
                    "type": "boolean",
                    "description": "Draw as a construction element. Default false.",
                },
            },
            "required": ["at"],
            "additionalProperties": False,
        ...
        WRITE,
        {
            ...
            "properties": {
                "start": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Where the line begins.",
                },
                "end": {
                    "type": "array",
                    "minItems": 2,
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Where the line ends.",
                },
                "sketch": {
                    "type": "string",
                    "minLength": 1,
        ...
        WRITE,
        {
            ...
            "properties": {
                "start": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "One end of the axis.",
                },
                "end": {
                    "type": "array",
                    "minItems": 2,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "at": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Centre of the circle. Defaults to the sketch origin.",
                },
                "plane": {
                    "type": "string",
                    "minLength": 1,
        ...
        WRITE,
        {
            ...
            "properties": {
                "start": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Where the arc begins.",
                },
                "through": {
                    "type": "array",
                    "minItems": 2,
                ...
                "end": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Where the arc ends.",
                },
                "sketch": {
                    "type": "string",
                    "minLength": 1,
        ...
        WRITE,
        {
            ...
            "properties": {
                "centre": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Centre of the ellipse.",
                },
                "major_radius_mm": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "tangent_intersection": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Where the two end tangents cross.",
                },
                "parameter": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "at": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Centre of the rectangle. Defaults to the sketch origin.",
                },
                "rotation_deg": {
                    "type": "number",
                    "minimum": -360.0,
        ...
        WRITE,
        {
            ...
            "properties": {
                "corner": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "The corner the two sides run from.",
                },
                "width_mm": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "at": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Centre of the polygon. Defaults to the sketch origin.",
                },
                "rotation_deg": {
                    "type": "number",
                    "minimum": -360.0,
        ...
        WRITE,
        {
            ...
            "properties": {
                "start": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Centre of the first end.",
                },
                "end": {
                    "type": "array",
                    "minItems": 2,
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Centre of the second end.",
                },
                "width_mm": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "axis": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The line or axis to mirror about.",
                },
                "keep_original": {
                    "type": "boolean",
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "offset": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "How far to move them, as a 2D vector.",
                },
                "copies": {
                    "type": "integer",
                    "minimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "centre": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "The point to scale about.",
                },
                "factor": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "centre": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Point to repeat around, for a circular grid. Default the sketch origin.",
                },
                "total_angle_deg": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "inner_diameter_mm": {
                    ...
                    "minimum": 0,
                    "maximum": 10000.0,
                    "description": "Bore diameter, for a tube. Omit it, or give 0, for a solid rod. Millimetres.",
                },
            },
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "axis": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The line or axis the plane rotates about.",
                },
                "angle_deg": {
                    "type": "number",
                    "minimum": -360.0,
        ...
        WRITE,
        {
            ...
            "properties": {
                "curve": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The curve to stand perpendicular to.",
                },
                "point": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Where on the curve. Defaults to its start.",
                },
                "name": {
                    "type": "string",
                    "minLength": 1,
        ...
        WRITE,
        {
            ...
            "properties": {
                "surface": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The surface to be tangent to.",
                },
                "point": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The point on the surface.",
                },
                "name": {
                    "type": "string",
                    "minLength": 1,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "reference": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Measure the coordinates from this point instead of the origin.",
                },
            },
            "required": ["at"],
            "additionalProperties": False,
        ...
        WRITE,
        {
            ...
            "properties": {
                "curve": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The curve to sit on.",
                },
                "ratio": {
                    "type": "number",
                    "minimum": 0.001,
        ...
        WRITE,
        {
            ...
            "properties": {
                "surface": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The surface to sit on.",
                },
                "reference": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The point to measure from.",
                },
                "direction": {
                    "type": "array",
                    "minItems": 3,
                    ...
                    "nonZero": True,
                    "description": "Which way to move along the surface.",
                },
                "distance_mm": {
                    "type": "number",
                    "minimum": -10000.0,
        ...
        WRITE,
        {
            ...
            "properties": {
                "element": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The circle, arc, sphere or face.",
                },
                "name": {
                    "type": "string",
                    "minLength": 1,
        ...
        WRITE,
        {
            ...
            "properties": {
                "surface": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The surface to stand off.",
                },
                "point": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The point on it.",
                },
                "length_mm": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                "curve": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The curve to be tangent to.",
                },
                "point": {
                    "type": "string",
                    "minLength": 1,
        ...
        WRITE,
        {
            ...
            "properties": {
                "origin": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The point the axis system sits at.",
                },
                "x_direction": {
                    "type": "array",
                    "minItems": 3,
                    ...
                    "items": {"type": "number", "minimum": -1000000.0, "maximum": 1000000.0},
                    "nonZero": True,
                    "description": "Direction of the local X axis.",
                },
                "y_direction": {
                    "type": "array",
                    "minItems": 3,
                    ...
                    "items": {"type": "number", "minimum": -1000000.0, "maximum": 1000000.0},
                    "nonZero": True,
                    "description": "Direction of the local Y axis.",
                },
                "name": {
                    "type": "string",
                    "minLength": 1,
        ...
        READ,
        {
            ...
            "properties": {
                "feature": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Restrict to faces created by this feature.",
                },
                "kind": {
                    "type": "string",
        ...
        READ,
        {
            ...
            "properties": {
                "feature": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Restrict to edges created by this feature.",
                },
                "face": {
                    "type": "string",
                    "minLength": 1,
        ...
        WRITE,
        {
            ...
            "properties": {
                "sketch": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The closed profile to extrude.",
                },
                "length_mm": {
                    "type": "number",
                    "exclusiveMinimum": 0,
                ...
                "up_to": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The plane, face or surface to stop at, for an up_to limit.",
                },
                "second_length_mm": {
                    "type": "number",
                    "exclusiveMinimum": 0,
                ...
                "direction": {
                    ...
                    "items": {"type": "number", "minimum": -1000000.0, "maximum": 1000000.0},
                    "nonZero": True,
                    "description": "Build along this direction instead of the profile's normal.",
                },
            },
        ...
        WRITE,
        {
            ...
            "properties": {
                "sketch": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The closed profile to cut.",
                },
                "depth_mm": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                "sketch": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The closed profile to revolve.",
                },
                "angle_deg": {
                    "type": "number",
                    "exclusiveMinimum": 0,
                ...
                "axis": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Revolve about this axis instead of the sketch's own.",
                },
        ...
        WRITE,
        {
            ...
            "properties": {
                "sketch": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The closed profile to revolve and remove.",
                },
                "angle_deg": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "feature": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Restrict to edges of this feature.",
                },
                "edges": {
                    "type": "string",
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "feature": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Mirror only this feature, not the whole body.",
                },
            },
            "required": ["plane"],
            "additionalProperties": False,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "feature": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The feature to repeat. Defaults to the last one.",
                },
                "reversed": {
                    "type": "boolean",
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "axis": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Rotate about this axis instead of the plane's normal.",
                },
                "radius_mm": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                "profile": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The closed profile to sweep.",
                },
                "centre_curve": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The path to sweep it along.",
                },
                "control": {
                    "type": "string",
                ...
                "reference": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The surface or direction the control uses.",
                },
                "thick": {
                    "type": "boolean",
        ...
        WRITE,
        {
            ...
            "properties": {
                "profile": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The open profile line.",
                },
                "thickness_mm": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "spine": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "A curve the sections stay normal to.",
                },
                "closed": {
                    "type": "boolean",
        ...
        WRITE,
        {
            ...
            "properties": {
                "first_profile": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The first closed profile.",
                },
                "second_profile": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The second closed profile.",
                },
                "first_direction": {
                    "type": "array",
                    "minItems": 3,
                    ...
                    "items": {"type": "number", "minimum": -1000000.0, "maximum": 1000000.0},
                    "nonZero": True,
                    "description": "Extrusion direction of the first profile.",
                },
                "second_direction": {
                    "type": "array",
                    "minItems": 3,
                    ...
                    "items": {"type": "number", "minimum": -1000000.0, "maximum": 1000000.0},
                    "nonZero": True,
                    "description": "Extrusion direction of the second profile.",
                },
            },
        ...
        WRITE,
        {
            ...
            "properties": {
                "sketch": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The profile to pad.",
                },
                "length_mm": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "at": {
                    ...
                    "maxItems": 3,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Where the hole centre sits. It must be a point ON the named face -- read the face's centre from catia_list_faces and offset from there, because a point in mid-air has nothing to drill into. All THREE coordinates are required: on a top face at z=20 that is [x, y, 20], not [x, y].",
                },
                "diameter_mm": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "hold_curve": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "A curve the fillet must pass through.",
                },
            },
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "pulling_direction": {
                    ...
                    "items": {"type": "number", "minimum": -1000000.0, "maximum": 1000000.0},
                    "nonZero": True,
                    "description": "Mould opening direction. Defaults to the neutral normal.",
                },
                "parting": {
                    "type": "string",
                    "minLength": 1,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "surface": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The surface to replace them with.",
                },
                "reversed": {
                    "type": "boolean",
        ...
        WRITE,
        {
            ...
            "properties": {
                "body": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The body to work in.",
                }
            },
            "required": ["body"],
            "additionalProperties": False,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "tool_body": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The body being combined in.",
                },
                "target_body": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The body to combine into. Defaults to the main body.",
                },
            },
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "body": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The body to move. Defaults to the active one.",
                },
            },
        ...
        WRITE,
        {
            ...
            "properties": {
                "axis": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The line or axis to rotate about.",
                },
                "angle_deg": {
                    "type": "number",
                    "minimum": -360.0,
                ...
                "body": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The body to rotate. Defaults to the active one.",
                },
            },
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "body": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The body to reflect. Defaults to the active one.",
                },
            },
            "required": ["reference"],
            "additionalProperties": False,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "body": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The body to scale. Defaults to the active one.",
                },
            },
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "axis_system": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The frame to scale in. Defaults to the part origin.",
                },
                "body": {
                    "type": "string",
                    "minLength": 1,
        ...
        WRITE,
        {
            ...
            "properties": {
                "positions": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The sketch whose points give the positions.",
                },
                "feature": {
                    "type": "string",
                    "minLength": 1,
                ...
                "anchor": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The point in the sketch the original sits on.",
                },
            },
            "required": ["positions"],
            "additionalProperties": False,
        ...
        WRITE,
        {
            ...
            "properties": {
                "pattern": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The pattern to explode.",
                }
            },
            "required": ["pattern"],
            "additionalProperties": False,
        ...
        WRITE,
        {
            ...
            "properties": {
                "feature": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The feature to rename.",
                },
                "name": {
                    "type": "string",
                    "minLength": 1,
        ...
        WRITE,
        {
            ...
            "properties": {
                "feature": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The feature to change.",
                },
                "active": {
                    "type": "boolean",
        ...
        WRITE,
        {
            ...
            "properties": {
                "feature": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The feature to move.",
                },
                "after": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The feature it should follow.",
                },
            },
        ...
        READ,
        {
            ...
            "properties": {
                "feature": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The feature to inspect.",
                },
                "depth": {
                    "type": "integer",
                    "minimum": 1,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "start_tangent": {
                    ...
                    "items": {"type": "number", "minimum": -1000000.0, "maximum": 1000000.0},
                    "nonZero": True,
                    "description": "Direction the curve leaves the first point.",
                },
                "end_tangent": {
                    "type": "array",
                    "minItems": 3,
                    ...
                    "items": {"type": "number", "minimum": -1000000.0, "maximum": 1000000.0},
                    "nonZero": True,
                    "description": "Direction it arrives at the last point.",
                },
                "support": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "A surface the spline must lie on.",
                },
                "closed": {
                    "type": "boolean",
                    "description": "Close the spline into a loop. Default false.",
        ...
        WRITE,
        {
            ...
            "properties": {
                "axis": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The axis the helix winds around.",
                },
                "start_point": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Where the helix begins.",
                },
                "pitch_mm": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                "first_curve": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The curve at one end.",
                },
                "second_curve": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The curve at the other end.",
                },
                "continuity": {
                    "type": "string",
        ...
        WRITE,
        {
            ...
            "properties": {
                "element": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The curve or point to project.",
                },
                "support": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The surface to project onto.",
                },
                "direction": {
                    "type": "array",
                    "minItems": 3,
                    ...
                    "items": {"type": "number", "minimum": -1000000.0, "maximum": 1000000.0},
                    "nonZero": True,
                    "description": "Project along this direction instead of normally.",
                },
                "nearest": {
                    "type": "boolean",
        ...
        WRITE,
        {
            ...
            "properties": {
                "first_curve": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The curve in the first view.",
                },
                "second_curve": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The curve in the second view.",
                },
                "first_direction": {
                    "type": "array",
                    "minItems": 3,
                    ...
                    "items": {"type": "number", "minimum": -1000000.0, "maximum": 1000000.0},
                    "nonZero": True,
                    "description": "Extrusion direction of the first curve.",
                },
                "second_direction": {
                    "type": "array",
                    "minItems": 3,
                    ...
                    "items": {"type": "number", "minimum": -1000000.0, "maximum": 1000000.0},
                    "nonZero": True,
                    "description": "Extrusion direction of the second.",
                },
                "name": {
                    "type": "string",
                    "minLength": 1,
        ...
        WRITE,
        {
            ...
            "properties": {
                "curve": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The curve to offset.",
                },
                "support": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The surface it lies on.",
                },
                "distance_mm": {
                    "type": "number",
                    "minimum": -10000.0,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "direction": {
                    ...
                    "items": {"type": "number", "minimum": -1000000.0, "maximum": 1000000.0},
                    "nonZero": True,
                    "description": "Which way to offset.",
                },
                "name": {
                    "type": "string",
                    "minLength": 1,
        ...
        WRITE,
        {
            ...
            "properties": {
                "element": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The surface or solid to cut.",
                },
                "plane": {
                    "type": "string",
                    "minLength": 1,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "direction": {
                    ...
                    "items": {"type": "number", "minimum": -1000000.0, "maximum": 1000000.0},
                    "nonZero": True,
                    "description": "The direction to find the extreme along.",
                },
                "second_direction": {
                    "type": "array",
                    "minItems": 3,
                    ...
                    "items": {"type": "number", "minimum": -1000000.0, "maximum": 1000000.0},
                    "nonZero": True,
                    "description": "Break ties along this direction.",
                },
                "maximum": {
                    "type": "boolean",
        ...
        WRITE,
        {
            ...
            "properties": {
                "surface": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The surface to find the line on.",
                },
                "direction": {
                    "type": "array",
                    "minItems": 3,
                    ...
                    "items": {"type": "number", "minimum": -1000000.0, "maximum": 1000000.0},
                    "nonZero": True,
                    "description": "The viewing or lighting direction.",
                },
                "angle_deg": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                "profile": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The curve to sweep.",
                },
                "direction": {
                    "type": "array",
                    "minItems": 3,
                    ...
                    "items": {"type": "number", "minimum": -1000000.0, "maximum": 1000000.0},
                    "nonZero": True,
                    "description": "Which way to sweep it.",
                },
                "length_mm": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                "profile": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The curve to revolve.",
                },
                "axis": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The axis to revolve about.",
                },
                "angle_deg": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                "surface": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The surface to offset from.",
                },
                "distance_mm": {
                    "type": "number",
                    "minimum": -10000.0,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "passing_point": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "A point the surface must pass through.",
                },
                "name": {
                    "type": "string",
                    "minLength": 1,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "guide": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The curve to sweep along.",
                },
                "profile": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The curve to sweep, for the explicit kind.",
                },
                "spine": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "A curve controlling the sweep's orientation.",
                },
                "reference_surface": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "A surface the profile stays at an angle to.",
                },
                "angle_deg": {
                    "type": "number",
                    "exclusiveMinimum": 0,
                ...
                "second_guide": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "A second guide curve.",
                },
                "name": {
                    "type": "string",
                    "minLength": 1,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "first_support": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The surface the first curve lies on.",
                },
                "second_support": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The surface the second curve lies on.",
                },
                "continuity": {
                    "type": "string",
                    "enum": ["point", "tangent", "curvature"],
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "centre": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Centre point, for a sphere.",
                },
                "axis": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Axis line, for a cylinder.",
                },
                "length_mm": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                "surface": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The surface to take the boundary of.",
                },
                "propagation": {
                    "type": "string",
                ...
                "limit_from": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Start the boundary here.",
                },
                "limit_to": {
                    "type": "string",
                    "minLength": 1,
        ...
        WRITE,
        {
            ...
            "properties": {
                "element": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "What to extend.",
                },
                "boundary": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The edge or endpoint to extend from.",
                },
                "length_mm": {
                    "type": "number",
                    "exclusiveMinimum": 0,
                ...
                "up_to": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Extend until it reaches this instead.",
                },
                "continuity": {
                    "type": "string",
        ...
        WRITE,
        {
            ...
            "properties": {
                "surface": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The surface to untrim.",
                },
                "name": {
                    "type": "string",
                    "minLength": 1,
        ...
        WRITE,
        {
            ...
            "properties": {
                "surface": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The closed surface to fill with material.",
                }
            },
            "required": ["surface"],
            "additionalProperties": False,
        ...
        WRITE,
        {
            ...
            "properties": {
                "surface": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The surface to thicken.",
                },
                "thickness_mm": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                "surface": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The surface to sew on.",
                },
                "remove": {
                    "type": "boolean",
        ...
        READ,
        {
            ...
            "properties": {
                ...
                "direction": {
                    ...
                    "items": {"type": "number", "minimum": -1000000.0, "maximum": 1000000.0},
                    "nonZero": True,
                    "description": "Pulling direction, for a draft analysis.",
                },
                "tolerance_mm": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "source": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The component to make another instance of.",
                },
                "parent": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The sub-assembly to add it under. Defaults to the root.",
                },
                "at": {
                    "type": "array",
                    "minItems": 3,
                    "maxItems": 3,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Where to place it. Defaults to the assembly origin.",
                },
            },
            "required": ["kind"],
            "additionalProperties": False,
        ...
        WRITE,
        {
            ...
            "properties": {
                "component": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The component to repeat.",
                },
                "count": {
                    "type": "integer",
                    "minimum": 2,
                ...
                "direction": {
                    ...
                    "items": {"type": "number", "minimum": -1000000.0, "maximum": 1000000.0},
                    "nonZero": True,
                    "description": "Which way the row runs.",
                },
            },
        ...
        WRITE,
        {
            ...
            "properties": {
                "component": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The component to replace.",
                },
                "replacement": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The document to put in its place.",
                },
                "all_instances": {
                    "type": "boolean",
        ...
        WRITE,
        {
            ...
            "properties": {
                "component": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The component to describe.",
                },
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "elements": {
                    ...
                    "maxItems": 50,
                    "items": {"type": "string", "minLength": 1, "maxLength": 120},
                    "description": "The geometry to constrain, one element for fix and two for everything else, each spelled Component/Geometry -- the component as the assembly names it, then one of its origin planes: XY, YZ or ZX (the seat's own label, e.g. 'Plan xy' on a French seat, is accepted too). In an assembly only the origin planes resolve by name. For fix, a bare component name pins its three origin planes. To make two turned parts coaxial, coincide two pairs of origin planes: Shaft/YZ with Bushing/YZ, then Shaft/ZX with Bushing/ZX. Never invent a path like 'Shaft@axis'; only names that exist resolve. If all you want is to put a component somewhere, do not go looking for geometry to reference at all -- catia_component_move takes a translation and needs no reference.",
                },
                "value": {
                    "type": "number",
                    "minimum": -10000.0,
        ...
        WRITE,
        {
            ...
            "properties": {
                "component": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Update only this sub-assembly.",
                }
            },
            "required": [],
            "additionalProperties": False,
        ...
        WRITE,
        {
            ...
            "properties": {
                "constraint": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The constraint to change.",
                },
                "active": {
                    "type": "boolean",
                    "description": "True to activate, false to deactivate.",
        ...
        WRITE,
        {
            ...
            "properties": {
                "component": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The component to move.",
                },
                "translation": {
                    "type": "array",
                    "minItems": 3,
                    "maxItems": 3,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "How far to move it, as a vector.",
                },
                "axis": {
                    "type": "string",
                    "minLength": 1,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "sketch": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The profile, for a pocket or add.",
                },
                "at": {
                    "type": "array",
                    "minItems": 3,
                ...
                "cutting": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The surface or plane, for a split.",
                },
            },
        ...
        READ,
        {
            ...
            "properties": {
                ...
                "component": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Restrict the analysis to this component.",
                },
            },
            "required": ["kind"],
            "additionalProperties": False,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "source": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The part or assembly to draw.",
                },
                "format": {
                    "type": "string",
                    "enum": [
        ...
        WRITE,
        {
            ...
            "properties": {
                "sheet": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Which sheet. Defaults to the active one.",
                },
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "at": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Where on the sheet to place it, in millimetres.",
                },
                "parent": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The view to project or detail from.",
                },
                "direction": {
                    "type": "array",
                    "minItems": 3,
                    ...
                    "items": {"type": "number", "minimum": -1000000.0, "maximum": 1000000.0},
                    "nonZero": True,
                    "description": "Viewing direction, for a front or auxiliary view.",
                },
                "section_line": {
                    "type": "array",
                    "minItems": 1,
                ...
                "centre": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Centre of the detail circle.",
                },
                "radius_mm": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                "view": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The view to change.",
                },
        ...
        WRITE,
        {
            ...
            "properties": {
                "view": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The view to align.",
                },
                "reference": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The view to align it to.",
                },
                "aligned": {
                    "type": "boolean",
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "view": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Which view. Defaults to the active one.",
                },
                "at": {
                    "type": "array",
                    "minItems": 2,
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Where to put the dimension text, in millimetres.",
                },
                "tolerance": {
                    "type": "string",
                    "maxLength": 60,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "view": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Which view.",
                },
                "datum": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The element to measure everything from.",
                },
            },
        ...
        WRITE,
        {
            ...
            "properties": {
                "view": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Which view. Defaults to all of them.",
                },
                "filter": {
                    "type": "string",
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "element": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The drawn element it applies to.",
                },
                "value_mm": {
                    "type": "number",
                    "exclusiveMinimum": 0,
                ...
                "at": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Where to put the frame, in millimetres.",
                },
            },
        ...
        WRITE,
        {
            ...
            "properties": {
                "element": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The drawn element that is the datum.",
                },
                ...
                "at": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Where to put the symbol, in millimetres.",
                },
            },
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "at": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Where to put it, in millimetres.",
                },
                "content": {
                    "type": "string",
                    "maxLength": 500,
                ...
                "leader_to": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Where the leader line points.",
                },
                "height_mm": {
                    "type": "number",
                    "exclusiveMinimum": 0,
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "at": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Where to put it, for a free-standing element.",
                },
                "pattern": {
                    "type": "string",
                    "maxLength": 60,
        ...
        WRITE,
        {
            ...
            "properties": {
                "at": {
                    ...
                    "maxItems": 2,
                    "items": {"type": "number", "minimum": -10000.0, "maximum": 10000.0},
                    "description": "Where to put the table, in millimetres.",
                },
                "kind": {
                    "type": "string",
        ...
        WRITE,
        {
            ...
            "properties": {
                "sheet": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "Which sheet. Defaults to all of them.",
                }
            },
            "required": [],
            "additionalProperties": False,
    ...
    "catia_drive_to": (
        WRITE,
        {
            ...
            "properties": {
                ...
                "measurement": {
                    "type": "string",
                    "enum": ["mass_kg", "volume_mm3", "area_mm2"],
                    "description": "Which measured property of the part to drive to the target.",
                },
                "target": {
                    "type": "number",
                    "description": "The value to reach, in the measurement's own unit -- kilograms, cubic millimetres or square millimetres. Nothing here converts units.",
                },
                "tolerance": {
                    "type": "number",
                    "exclusiveMinimum": 0,
                    "description": "How close counts as reached, as a fraction of the target. Default 0.01, which is 1%.",
                },
                "also": {
                    "type": "array",
                    "minItems": 1,
                    "maxItems": 50,
                    "items": {"type": "string", "minLength": 1, "maxLength": 120},
                    "description": "Other parameters to hold equal to the one being driven, by name. 'keeping the width and height equal' is this.",
                },
                "max_attempts": {
                    "type": "integer",
                    "minimum": 2,
                    "maximum": 20,
                    "description": "How many rebuilds to allow. Default 8.",
                },
            },
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "set": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "A parameter set to create it inside.",
                },
        ...
        WRITE,
        {
            ...
            "properties": {
                ...
                "parent": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "A set to nest it inside.",
                },
            },
            "required": ["name"],
            "additionalProperties": False,
        ...
        WRITE,
        {
            ...
            "properties": {
                "parameter": {
                    ...
                    "minLength": 1,
                    "maxLength": 120,
                    "description": "The parameter the formula drives.",
                },
                "expression": {
                    "type": "string",
                    "maxLength": 1000,
